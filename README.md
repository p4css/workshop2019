...
2. 下載以下資料集（[Deleted accounts and tweets](https://www.dropbox.com/s/nix3qai2giu3lss/data.zip?dl=0), 1.57GB, Very large），並將資料集內的.csv檔案拖至前步驟資料夾中的data資料夾內。或下載[presave.rda](https://www.dropbox.com/s/3owujqk574cnnyc/presave.rda?dl=0)檔，以備使用。
3. 依照影片內容設定環境
4. 依照影片內容了解Ｒ的基本使用
